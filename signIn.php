<div style="background-color: #e6e6fa; height: 110%;">
<?php
	$title = "User SignIn";
	require_once "./template/header.php";
?>

	<form class="form-horizontal" method="post" action="user_verify.php" style="display: flex; justify-content: center; align-items: center; height: 100vh;">
    <div class="input-container" style="background-color: #add8e6; padding: 35px;">
      <div class="form-group">
        <label for="exampleInputEmail1">Username</label></h4>
      ...
      <div class="form-group">
        <label for="exampleInputPassword1">Password</label></h4>
